...
/**
 * Created by michaelfrederickson on 12/11/14.
 */
public class PlayMetronome implements Runnable {
    ...
    public PlayMetronome(int tempo, int[] timeSignature, int accent, int subdivision){
